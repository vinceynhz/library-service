...
def run_jar_command(src_path, app_name, profiles, jvm=None, jva=None):
    if jvm is None:
    ...
    command = "java " + jvm + " -Dspring.profiles.active=" + profiles + " -jar " + app_name + jva
...
def read_app_props(pom_path, values='all'):
