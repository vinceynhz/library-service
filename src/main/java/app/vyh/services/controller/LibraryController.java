...
public class LibraryController {
     ...
     *                                   in {@link app.vyh.services.model.request.book.UpdateQtyActionEnum}
     */
    @PatchMapping(path = "/books/{bookId}")
    public ResponseEntity<LibraryResponse> patchBook(@PathVariable Integer bookId, @RequestBody UpdateBookRequest request)
    throws LibraryOperationException {
        LibraryResponse response = libraryService.updateBookQty(bookId, request);
        return serviceResponse(response);
    }
